...
class RecommendProduct extends AbstractEntity
{
    ...
    /**
     * @var \Customize\Entity\Master\RecommendKbn
     *
     * @ORM\ManyToOne(targetEntity="Eccube\Entity\Category", inversedBy="ProductCategories")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="recommend_kbn_id", referencedColumnName="id" , nullable=true)
     * })
     */
    private $RecommendKbn;
    ...
    public function setCategory(Category|null $Category): self
    {
    ...
    public function setRecommendKbn(RecommendKbn|null $RecommendKbn): self
    {
        $this->RecommendKbn = $RecommendKbn;

        return $this;
    }
    public function getRecommendKbn(): RecommendKbn|null
    {
