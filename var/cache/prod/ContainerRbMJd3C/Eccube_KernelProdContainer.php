...
class Eccube_KernelProdContainer extends Container
{
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'orm'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Cache'.\DIRECTORY_SEPARATOR.'CacheConfiguration.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'orm'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Cache'.\DIRECTORY_SEPARATOR.'CacheFactory.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'orm'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Cache'.\DIRECTORY_SEPARATOR.'DefaultCacheFactory.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'orm'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Cache'.\DIRECTORY_SEPARATOR.'RegionsConfiguration.php';
        ...
        $i = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [(\dirname(__DIR__, 4).'/app/Plugin/AmazonPayV2_42_Bundle/Entity')]);
        $i->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $j = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [(\dirname(__DIR__, 4).'/app/Plugin/Api42/Entity')]);
        $j->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $k = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [(\dirname(__DIR__, 4).'/app/Plugin/Coupon42/Entity')]);
        $k->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $l = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [(\dirname(__DIR__, 4).'/app/Plugin/EccubePaymentLite42/Entity')]);
        $l->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $m = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [(\dirname(__DIR__, 4).'/app/Plugin/MailMagazine42/Entity')]);
        $m->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $n = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [(\dirname(__DIR__, 4).'/app/Plugin/ProductReview42/Entity')]);
        $n->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $o = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [(\dirname(__DIR__, 4).'/app/Plugin/Recommend42/Entity')]);
        $o->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $p = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [(\dirname(__DIR__, 4).'/app/Plugin/RelatedProduct42/Entity')]);
        $p->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $q = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [(\dirname(__DIR__, 4).'/app/Plugin/Securitychecker42/Entity')]);
        $q->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $r = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [(\dirname(__DIR__, 4).'/app/Plugin/SiteKit42/Entity')]);
        ...
        $e->addDriver($i, 'Plugin\\AmazonPayV2_42_Bundle\\Entity');
        $e->addDriver($j, 'Plugin\\Api42\\Entity');
        $e->addDriver($k, 'Plugin\\Coupon42\\Entity');
        $e->addDriver($l, 'Plugin\\EccubePaymentLite42\\Entity');
        $e->addDriver($m, 'Plugin\\MailMagazine42\\Entity');
        $e->addDriver($n, 'Plugin\\ProductReview42\\Entity');
        $e->addDriver($o, 'Plugin\\Recommend42\\Entity');
        $e->addDriver($p, 'Plugin\\RelatedProduct42\\Entity');
        $e->addDriver($q, 'Plugin\\Securitychecker42\\Entity');
        $e->addDriver($r, 'Plugin\\SiteKit42\\Entity');
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'log/prod/admin.log'), 60, 'debug', true, NULL, false);
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'log/prod/front.log'), 60, 'debug', true, NULL, false);
        $a->pushProcessor(($container->privates['monolog.processor.psr_log_message'] ??= new \Monolog\Processor\PsrLogMessageProcessor()));
        $a->setFilenameFormat('{filename}-{date}', 'Y-m-d');
        $a->setFormatter(($container->privates['eccube.log.formatter.line'] ?? self::getEccube_Log_Formatter_LineService($container)));
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'log/prod/site.log'), 60, 'debug', true, NULL, false);
        $a->pushProcessor(($container->privates['monolog.processor.psr_log_message'] ??= new \Monolog\Processor\PsrLogMessageProcessor()));
        $a->setFilenameFormat('{filename}-{date}', 'Y-m-d');
        $a->setFormatter(($container->privates['eccube.log.formatter.line'] ?? self::getEccube_Log_Formatter_LineService($container)));
    ...
    protected static function getSecurity_Firewall_MapService($container)
    {
        ...
        return $container->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.firewall.map.context.admin' => ($container->privates['.security.request_matcher.5MJGZGY'] ?? $container->load('get_Security_RequestMatcher_5MJGZGYService'));
