 ...
 */
class get_Security_RequestMatcher_GPC3IService extends Eccube_KernelInstallContainer
{
    /*
     * Gets the private '.security.request_matcher.GPC3__I' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['.security.request_matcher.GPC3__I'] = new \Symfony\Component\HttpFoundation\ChainRequestMatcher([($container->privates['.security.request_matcher.MbivekT'] ??= new \Symfony\Component\HttpFoundation\RequestMatcher\PathRequestMatcher('^/'.$container->getEnv('string:ECCUBE_ADMIN_ROUTE').'/'))]);
    }
}
