...
class getWithdrawControllerService extends Eccube_KernelInstallContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.VSHY1OV'] ?? $container->load('get_ServiceLocator_VSHY1OVService'))->withContext('Eccube\\Controller\\Mypage\\WithdrawController', $container));
