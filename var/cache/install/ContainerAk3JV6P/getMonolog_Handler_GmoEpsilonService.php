 ...
 */
class getMonolog_Handler_GmoEpsilonService extends Eccube_KernelInstallContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'log/install/gmo_epsilon.log'), '60', 'debug', true, NULL, false);
