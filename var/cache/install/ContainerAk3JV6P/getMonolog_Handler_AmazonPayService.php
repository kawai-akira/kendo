 ...
 */
class getMonolog_Handler_AmazonPayService extends Eccube_KernelInstallContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'log/install/amazon_pay_v2.log'), 60, 'debug', true, NULL, false);
