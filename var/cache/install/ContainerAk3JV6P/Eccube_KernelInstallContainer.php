...
class Eccube_KernelInstallContainer extends Container
{
    ...
    {
        $container->privates['monolog.handler.main'] = $instance = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'log/install/site.log'), 10, 'debug', true, NULL, false);
    ...
    protected static function getSecurity_Firewall_MapService($container)
    {
        ...
        return $container->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.firewall.map.context.admin' => ($container->privates['.security.request_matcher.GPC3__I'] ?? $container->load('get_Security_RequestMatcher_GPC3IService'));
