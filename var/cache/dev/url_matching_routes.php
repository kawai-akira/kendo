...
return [
    ...
    [ // $staticRoutes
        ...
        '/backOffice/product/class_name/export' => [[['_route' => 'admin_product_class_name_export', '_controller' => 'Eccube\\Controller\\Admin\\Product\\ClassNameController::export'], null, ['GET' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        ...
        '/backOffice/product/class_name_csv_upload' => [[['_route' => 'admin_product_class_name_csv_import', '_controller' => 'Eccube\\Controller\\Admin\\Product\\CsvImportController::csvClassName'], null, ['GET' => 0, 'POST' => 1], ['https' => 0, 'http' => 1], false, false, null]],
        '/backOffice/product/class_category_csv_upload' => [[['_route' => 'admin_product_class_category_csv_import', '_controller' => 'Eccube\\Controller\\Admin\\Product\\CsvImportController::csvClassCategory'], null, ['GET' => 0, 'POST' => 1], ['https' => 0, 'http' => 1], false, false, null]],
        ...
        '/backOffice/product/product/image/process' => [[['_route' => 'admin_product_image_process', '_controller' => 'Eccube\\Controller\\Admin\\Product\\ProductController::imageProcess'], null, ['POST' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        '/backOffice/product/product/image/load' => [[['_route' => 'admin_product_image_load', '_controller' => 'Eccube\\Controller\\Admin\\Product\\ProductController::imageLoad'], null, ['GET' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        '/backOffice/product/product/image/revert' => [[['_route' => 'admin_product_image_revert', '_controller' => 'Eccube\\Controller\\Admin\\Product\\ProductController::imageRevert'], null, ['DELETE' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        ...
        '/backOffice/setting/shop/calendar' => [[['_route' => 'admin_setting_shop_calendar', '_controller' => 'Eccube\\Controller\\Admin\\Setting\\Shop\\CalendarController::index'], null, ['GET' => 0, 'POST' => 1], ['https' => 0, 'http' => 1], false, false, null]],
        '/backOffice/setting/shop/calendar/new' => [[['_route' => 'admin_setting_shop_calendar_new', '_controller' => 'Eccube\\Controller\\Admin\\Setting\\Shop\\CalendarController::index'], null, ['GET' => 0, 'POST' => 1], ['https' => 0, 'http' => 1], false, false, null]],
        ...
        '/backOffice/setting/shop/payment/image/process' => [[['_route' => 'admin_payment_image_process', '_controller' => 'Eccube\\Controller\\Admin\\Setting\\Shop\\PaymentController::imageProcess'], null, ['POST' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        '/backOffice/setting/shop/payment/image/load' => [[['_route' => 'admin_payment_image_load', '_controller' => 'Eccube\\Controller\\Admin\\Setting\\Shop\\PaymentController::imageLoad'], null, ['GET' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        '/backOffice/setting/shop/payment/image/revert' => [[['_route' => 'admin_payment_image_revert', '_controller' => 'Eccube\\Controller\\Admin\\Setting\\Shop\\PaymentController::imageRevert'], null, ['DELETE' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        ...
        '/backOffice/setting/shop/tradelaw' => [[['_route' => 'admin_setting_shop_tradelaw', '_controller' => 'Eccube\\Controller\\Admin\\Setting\\Shop\\TradeLawController::index'], null, ['GET' => 0, 'POST' => 1], ['https' => 0, 'http' => 1], false, false, null]],
        ...
        '/backOffice/MyTest' => [[['_route' => 'admin_my_test', '_controller' => 'Customize\\Controller\\Admin\\AdminMyTestController::index'], null, ['GET' => 0, 'POST' => 1], ['https' => 0, 'http' => 1], false, false, null]],
    ...
    [ // $regexpList
        0 => '{^(?'
                ...
                .')'
                .'|/cart/(?'
                    .'|(up|down|remove)/(\\d+)(*:2324)'
                    .'|buystep/([a-zA-Z0-9]+[_][\\x20-\\x7E]+)(*:2370)'
                .')'
                .'|/entry/activate/([^/]++)(?:/([^/]++))?(*:2418)'
                .'|/forgot/reset/([^/]++)(*:2449)'
                .'|/install/plugin/(\\w+)/enable(*:2486)'
                .'|/mypage/(?'
                    .'|delivery/(?'
                        .'|(\\d+)/edit(*:2528)'
                        .'|([^/]++)/delete(*:2552)'
    ...
    [ // $dynamicRoutes
        ...
        2324 => [[['_route' => 'cart_handle_item', '_controller' => 'Eccube\\Controller\\CartController::handleCartItem'], ['operation', 'productClassId'], ['PUT' => 0], ['https' => 0, 'http' => 1], false, true, null]],
        2370 => [[['_route' => 'cart_buystep', '_controller' => 'Eccube\\Controller\\CartController::buystep'], ['cart_key'], ['GET' => 0], ['https' => 0, 'http' => 1], false, true, null]],
        2418 => [[['_route' => 'entry_activate', 'qtyInCart' => null, '_controller' => 'Eccube\\Controller\\EntryController::activate'], ['secret_key', 'qtyInCart'], ['GET' => 0], ['https' => 0, 'http' => 1], false, true, null]],
        2449 => [[['_route' => 'forgot_reset', '_controller' => 'Eccube\\Controller\\ForgotController::reset'], ['reset_key'], ['GET' => 0, 'POST' => 1], ['https' => 0, 'http' => 1], false, true, null]],
        2486 => [[['_route' => 'install_plugin_enable', '_controller' => 'Eccube\\Controller\\InstallPluginController::pluginEnable'], ['code'], ['PUT' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        2528 => [[['_route' => 'mypage_delivery_edit', 'id' => null, '_controller' => 'Eccube\\Controller\\Mypage\\DeliveryController::edit'], ['id'], ['GET' => 0, 'POST' => 1], ['https' => 0, 'http' => 1], false, false, null]],
        2552 => [[['_route' => 'mypage_delivery_delete', '_controller' => 'Eccube\\Controller\\Mypage\\DeliveryController::delete'], ['id'], ['DELETE' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        2578 => [[['_route' => 'mypage_history', '_controller' => 'Eccube\\Controller\\Mypage\\MypageController::history'], ['order_no'], ['GET' => 0], ['https' => 0, 'http' => 1], false, true, null]],
        2601 => [[['_route' => 'mypage_order', '_controller' => 'Eccube\\Controller\\Mypage\\MypageController::order'], ['order_no'], ['PUT' => 0], ['https' => 0, 'http' => 1], false, true, null]],
        2631 => [[['_route' => 'mypage_favorite_delete', '_controller' => 'Eccube\\Controller\\Mypage\\MypageController::delete'], ['id'], ['DELETE' => 0], ['https' => 0, 'http' => 1], false, false, null]],
        2666 => [[['_route' => 'product_detail', '_controller' => 'Eccube\\Controller\\ProductController::detail'], ['id'], ['GET' => 0], ['https' => 0, 'http' => 1], false, true, null]],
        2696 => [[['_route' => 'product_add_favorite', '_controller' => 'Eccube\\Controller\\ProductController::addFavorite'], ['id'], ['GET' => 0, 'POST' => 1], ['https' => 0, 'http' => 1], false, true, null]],
        2715 => [[['_route' => 'product_add_cart', '_controller' => 'Eccube\\Controller\\ProductController::addCart'], ['id'], ['POST' => 0], ['https' => 0, 'http' => 1], false, true, null]],
