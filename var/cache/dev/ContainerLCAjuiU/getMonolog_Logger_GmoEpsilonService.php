 ...
 */
class getMonolog_Logger_GmoEpsilonService extends Eccube_KernelDevDebugContainer
{
    /**
     * Gets the public 'monolog.logger.gmo_epsilon' shared service.
     *
     * @return \Monolog\Logger
     */
    public static function do($container, $lazyLoad = true)
    {
        $container->services['monolog.logger.gmo_epsilon'] = $instance = new \Monolog\Logger('gmo_epsilon');
        ...
        $instance->pushHandler(($container->privates['monolog.handler.gmo_epsilon'] ?? $container->load('getMonolog_Handler_GmoEpsilonService')));
