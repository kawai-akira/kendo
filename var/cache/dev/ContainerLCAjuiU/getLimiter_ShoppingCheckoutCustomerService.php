...
class getLimiter_ShoppingCheckoutCustomerService extends Eccube_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['limiter.shopping_checkout_customer'] = new \Symfony\Component\RateLimiter\RateLimiterFactory(['policy' => 'fixed_window', 'limit' => 1024, 'interval' => '30 minutes', 'id' => 'shopping_checkout_customer'], new \Symfony\Component\RateLimiter\Storage\CacheStorage(($container->privates['rate_limiter.cache'] ?? self::getRateLimiter_CacheService($container))), ($container->privates['lock.default.factory'] ?? $container->load('getLock_Default_FactoryService')));
    }
}
