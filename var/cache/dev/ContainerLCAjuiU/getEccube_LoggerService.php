...
class getEccube_LoggerService extends Eccube_KernelDevDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['eccube.logger'] = $container->createProxy('LoggerGhost58b19e7', static fn () => \LoggerGhost58b19e7::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
