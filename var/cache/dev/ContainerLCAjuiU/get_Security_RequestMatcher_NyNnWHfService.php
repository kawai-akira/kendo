 ...
 */
class get_Security_RequestMatcher_NyNnWHfService extends Eccube_KernelDevDebugContainer
{
    /**
     * Gets the private '.security.request_matcher.NyNnWHf' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['.security.request_matcher.NyNnWHf'] = new \Symfony\Component\HttpFoundation\ChainRequestMatcher([($container->privates['.security.request_matcher.Aph0gsd'] ??= new \Symfony\Component\HttpFoundation\RequestMatcher\PathRequestMatcher('^/'.$container->getEnv('string:ECCUBE_ADMIN_ROUTE').'/'))]);
    }
}
