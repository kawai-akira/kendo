...
class getAbstractShoppingControllerService extends Eccube_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.M2tV667'] ?? $container->load('get_ServiceLocator_M2tV667Service'))->withContext('Eccube\\Controller\\AbstractShoppingController', $container));
