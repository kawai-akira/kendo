...
class Eccube_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'Customize\\Controller\\Admin\\AdminConverterController' => 'getAdminConverterControllerService',
            'Customize\\Controller\\Admin\\AdminMyTestController' => 'getAdminMyTestControllerService',
            ...
            'Plugin\\DataMigrationBackup30\\Controller\\Admin\\BackupController' => 'getBackupControllerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'app'.\DIRECTORY_SEPARATOR.'Plugin'.\DIRECTORY_SEPARATOR.'DataMigrationBackup30'.\DIRECTORY_SEPARATOR.'Twig'.\DIRECTORY_SEPARATOR.'BootstrapHelperExtension.php';
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $h = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [(\dirname(__DIR__, 4).'/app/Plugin/Coupon42/Entity')]);
        $h->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $i = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [(\dirname(__DIR__, 4).'/app/Plugin/EccubePaymentLite42/Entity')]);
        $i->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $j = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [(\dirname(__DIR__, 4).'/app/Plugin/MailMagazine42/Entity')]);
        $j->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $k = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [(\dirname(__DIR__, 4).'/app/Plugin/ProductReview42/Entity')]);
        $k->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $l = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [(\dirname(__DIR__, 4).'/app/Plugin/Recommend42/Entity')]);
        $l->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $m = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [(\dirname(__DIR__, 4).'/app/Plugin/RelatedProduct42/Entity')]);
        $m->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $n = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [(\dirname(__DIR__, 4).'/app/Plugin/Securitychecker42/Entity')]);
        $n->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $o = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [(\dirname(__DIR__, 4).'/app/Plugin/SiteKit42/Entity')]);
        ...
        $b->addDriver($i, 'Plugin\\EccubePaymentLite42\\Entity');
        $b->addDriver($j, 'Plugin\\MailMagazine42\\Entity');
        $b->addDriver($k, 'Plugin\\ProductReview42\\Entity');
        $b->addDriver($l, 'Plugin\\Recommend42\\Entity');
        $b->addDriver($m, 'Plugin\\RelatedProduct42\\Entity');
        $b->addDriver($n, 'Plugin\\Securitychecker42\\Entity');
        $b->addDriver($o, 'Plugin\\SiteKit42\\Entity');
    ...
    protected static function getTwigService($container)
    {
        ...
        $a->addPath((\dirname(__DIR__, 4).'/app/Plugin/DataMigrationBackup30/Resource/template'), 'DataMigrationBackup30');
        ...
        $instance->addExtension(new \Plugin\DataMigrationBackup30\Twig\BootstrapHelperExtension());
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'mail_magazine_dir' => (\dirname(__DIR__, 4).'/app/PluginData/mail_magazine'),
