...
class getPluginServiceService extends Eccube_KernelDevDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['Eccube\\Service\\PluginService'] = $container->createProxy('PluginServiceGhost785f398', static fn () => \PluginServiceGhost785f398::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
