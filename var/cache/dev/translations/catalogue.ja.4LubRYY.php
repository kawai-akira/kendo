...
',
  ...
  'messages' => 
  array (
    'data_migration_backup.admin.nav.title' => '移行バックアップ',
    'data_migration_backup.admin.nav.index' => 'バックアップ作成',
    'data_migration_backup.admin.nav.files' => 'バックアップ一覧',
    'data_migration_backup.admin.nav.guide' => '使い方',
    'data_migration_backup.admin.nav.scanner' => '事前診断',
    'data_migration_backup.admin.form.title' => 'バックアップ対象',
    'data_migration_backup.admin.form.backup_profile' => 'バックアップ設定',
    'data_migration_backup.admin.form.backup_profile_default' => '移行用デフォルト設定を使用',
    'data_migration_backup.admin.form.backup_profile_custom' => 'カスタム設定でバックアップ',
    'data_migration_backup.admin.form.backup_db' => 'データベースをバックアップ',
    'data_migration_backup.admin.form.db_scope_all' => 'すべてのテーブルをバックアップ',
    'data_migration_backup.admin.form.db_scope_selected' => 'テーブルを選択してバックアップ',
    'data_migration_backup.admin.form.table_list' => 'バックアップ対象テーブル',
    'data_migration_backup.admin.form.table_uncheck_all' => 'すべて解除',
    'data_migration_backup.admin.form.backup_plugin' => 'プラグインをバックアップ',
    'data_migration_backup.admin.form.backup_theme' => '現在のテーマをバックアップ',
    'data_migration_backup.admin.form.backup_assets' => '公開ディレクトリのファイルをバックアップ',
    'data_migration_backup.admin.form.backup_app_assets' => 'テンプレート側のファイルをバックアップ',
    'data_migration_backup.admin.form.run' => 'バックアップを開始',
    'data_migration_backup.admin.precheck.title' => '実行前チェック',
    'data_migration_backup.admin.precheck.estimate' => '推定バックアップサイズ',
    'data_migration_backup.admin.precheck.required' => '必要空き容量目安',
    'data_migration_backup.admin.precheck.item' => '項目',
    'data_migration_backup.admin.precheck.value' => '値',
    'data_migration_backup.admin.precheck.status' => '判定',
    'data_migration_backup.admin.precheck.note' => '補足',
    'data_migration_backup.admin.progress.title' => 'バックアップを実行中です',
    'data_migration_backup.admin.progress.note' => '処理が完了するまでこのままお待ちください。',
    'data_migration_backup.admin.progress.done' => 'バックアップが完了しました。ダウンロードを開始します。',
    'data_migration_backup.admin.progress.warning' => 'ブラウザを閉じないでください。',
    'data_migration_backup.admin.files.title' => '生成済みバックアップ',
    'data_migration_backup.admin.files.name' => 'ファイル名',
    'data_migration_backup.admin.files.type' => '種別',
    'data_migration_backup.admin.files.size' => 'サイズ',
    'data_migration_backup.admin.files.date' => '作成日時',
    'data_migration_backup.admin.files.action' => '操作',
    'data_migration_backup.admin.files.download' => 'ダウンロード',
    'data_migration_backup.admin.files.restore' => '復元',
    'data_migration_backup.admin.files.delete' => '削除',
    'data_migration_backup.admin.files.delete_all' => 'すべて削除',
    'data_migration_backup.admin.files.empty' => '生成済みバックアップはありません。',
    'data_migration_backup.admin.scanner.step1' => '移行先設定',
    'data_migration_backup.admin.scanner.step2' => 'スキャン条件',
    'data_migration_backup.admin.scanner.step3' => 'プレビュー',
    'data_migration_backup.admin.scanner.step4' => '判定結果',
    'data_migration_backup.admin.scanner.target_setup_title' => '移行先バックアップファイルとバージョン設定',
    'data_migration_backup.admin.scanner.target_summary_title' => '移行先設定',
    'data_migration_backup.admin.scanner.target_version_title' => '移行先EC-CUBEバージョン',
    'data_migration_backup.admin.scanner.no_higher_target_version' => '現在のEC-CUBEバージョンより上位の選択肢がありません。',
    'data_migration_backup.admin.scanner.source_info_title' => '移行元サイト情報',
    'data_migration_backup.admin.scanner.option_title' => '実行オプション',
    'data_migration_backup.admin.scanner.connector_title' => '連携プラグイン状態',
    'data_migration_backup.admin.scanner.target_source_title' => 'スキャン対象ファイル',
    'data_migration_backup.admin.scanner.target_source_current' => '現在のシステムを利用',
    'data_migration_backup.admin.scanner.target_source_upload' => '新規アップロード',
    'data_migration_backup.admin.scanner.target_source_saved' => 'バックアップ一覧のファイルを利用',
    'data_migration_backup.admin.scanner.source_file' => '移行元バックアップファイル',
    'data_migration_backup.admin.scanner.source_file_note' => '現在のシステムを利用するか、バックアップ一覧のファイル、または新規アップロードを選択してください。',
    'data_migration_backup.admin.scanner.source_current_note' => '現在のシステムの最新情報を利用します。',
    'data_migration_backup.admin.scanner.source_file_empty' => '利用できるファイルがありません。アップロードを選択してください。',
    'data_migration_backup.admin.scanner.source_upload_required' => '移行元バックアップファイルをアップロードしてください。',
    'data_migration_backup.admin.scanner.target_file' => '移行先バックアップファイル',
    'data_migration_backup.admin.scanner.target_file_note' => '移行先サイトで作成したバックアップファイル（.tar.gz / .tgz / .tar / .zip）をアップロードして互換性を確認します。',
    'data_migration_backup.admin.scanner.target_file_help_text' => 'このファイルはどこから取得できますか',
    'data_migration_backup.admin.scanner.target_file_help_aria' => 'ファイルの取得方法',
    'data_migration_backup.admin.scanner.target_file_help_title' => 'ファイルの取得方法',
    'data_migration_backup.admin.scanner.target_file_replace_title' => '移行先バックアップファイル',
    'data_migration_backup.admin.scanner.target_file_replace_label' => '比較対象の移行先バックアップファイル',
    'data_migration_backup.admin.scanner.target_file_replace_note' => 'すでに読み込んだファイルを差し替える場合にアップロードしてください。',
    'data_migration_backup.admin.scanner.target_file_replace_button' => 'ファイルを差し替える',
    'data_migration_backup.admin.scanner.target_file_select_required' => '移行先バックアップファイルを選択してください。',
    'data_migration_backup.admin.scanner.saved_files_title' => 'バックアップ一覧（移行用デフォルト）',
    'data_migration_backup.admin.scanner.saved_file_name' => 'ファイル名',
    'data_migration_backup.admin.scanner.saved_file_size' => 'サイズ',
    'data_migration_backup.admin.scanner.saved_file_updated_at' => '更新日時',
    'data_migration_backup.admin.scanner.saved_file_type' => '種別',
    'data_migration_backup.admin.scanner.uploaded_file_name' => 'アップロード済みファイル',
    'data_migration_backup.admin.scanner.uploaded_file_size' => 'サイズ',
    'data_migration_backup.admin.scanner.uploaded_file_updated_at' => '更新日時',
    'data_migration_backup.admin.scanner.scan_target' => '対象',
    'data_migration_backup.admin.scanner.plugin_name' => 'プラグイン名',
    'data_migration_backup.admin.scanner.plugin_code' => 'コード',
    'data_migration_backup.admin.scanner.plugin_version' => 'バージョン',
    'data_migration_backup.admin.scanner.plugin_count' => '有効プラグイン数',
    'data_migration_backup.admin.scanner.plugin_list' => '有効プラグイン',
    'data_migration_backup.admin.scanner.generated_at' => '取得日時',
    'data_migration_backup.admin.scanner.connector_target_label' => '移行先プラグイン',
    'data_migration_backup.admin.scanner.connector_target_none' => '選択してください',
    'data_migration_backup.admin.scanner.connector_scan_waiting' => '移行先プラグインを選択すると互換性をチェックします。',
    'data_migration_backup.admin.scanner.connector_pending' => '未選択',
    'data_migration_backup.admin.scanner.connector_supported' => '移行可',
    'data_migration_backup.admin.scanner.connector_unsupported' => '移行不可',
    'data_migration_backup.admin.scanner.modules_required' => '移行対象データを1つ以上選択してください。',
    'data_migration_backup.admin.scanner.chunk_uploading' => 'ファイルをアップロード中です',
    'data_migration_backup.admin.scanner.chunk_uploaded' => 'ファイルのアップロードが完了しました',
    'data_migration_backup.admin.scanner.chunk_failed' => 'ファイルのアップロードに失敗しました',
    'data_migration_backup.admin.scanner.chunk_init_failed' => 'アップロードの初期化に失敗しました。',
    'data_migration_backup.admin.scanner.chunk_append_failed' => 'チャンクの送信に失敗しました。',
    'data_migration_backup.admin.scanner.chunk_complete_failed' => 'アップロードの完了処理に失敗しました。',
    'data_migration_backup.admin.scanner.scan_failed' => '連携プラグイン状態の取得に失敗しました。',
    'data_migration_backup.admin.scanner.next' => '次へ',
    'data_migration_backup.admin.scanner.back' => '戻る',
    'data_migration_backup.admin.scanner.back_to_conditions' => '条件へ戻る',
    'data_migration_backup.admin.scanner.run' => 'スキャン実行',
    'data_migration_backup.admin.scanner.no_plugin' => '有効化されている連携プラグインはありません。',
    'data_migration_backup.admin.scanner.no_saved_file' => '利用可能な「移行用デフォルト」ファイルがありません。先にバックアップを作成してください。',
    'data_migration_backup.admin.scanner.result_title' => 'スキャン結果',
    'data_migration_backup.admin.scanner.result_ok' => '移行可',
    'data_migration_backup.admin.scanner.result_warning' => '要確認',
    'data_migration_backup.admin.scanner.result_error' => '移行不可',
    'data_migration_backup.admin.scanner.source_version' => '移行元バージョン',
    'data_migration_backup.admin.scanner.target_version' => '移行先バージョン',
    'data_migration_backup.admin.scanner.target_generated_at' => '移行先ファイル生成日時',
    'data_migration_backup.admin.scanner.plugin_target' => '移行先プラグイン',
    'data_migration_backup.admin.scanner.status' => '判定',
    'data_migration_backup.admin.scanner.note' => '詳細',
    'data_migration_backup.admin.scanner.step3_table_stats_note' => 'この一覧は「移行元サイト」から取得した件数です。移行時に、表示内容に基づいて「移行先サイト」のデータが新規登録または更新されます。',
    'data_migration_backup.admin.scanner.step3_preview_description' => 'このプレビューは「移行元サイト」から取得したデータです。移行時に、表示内容に基づいて「移行先サイト」のデータが新規登録または更新されます。',
    'data_migration_backup.admin.message.invalid_csrf' => 'CSRFトークンが無効です。',
    'data_migration_backup.admin.message.select_component' => 'バックアップ対象を1つ以上選択してください。',
    'data_migration_backup.admin.message.precheck_ng' => '実行前チェックに要確認項目があります。必要に応じて環境設定を見直してください。',
    'data_migration_backup.admin.message.failed' => 'バックアップに失敗しました',
    'data_migration_backup.admin.message.run_confirm' => 'バックアップを開始します。よろしいですか？',
    'data_migration_backup.admin.message.delete_confirm' => 'このバックアップを削除します。よろしいですか？',
    'data_migration_backup.admin.message.delete_done' => 'バックアップを削除しました。',
    'data_migration_backup.admin.message.delete_failed' => 'バックアップの削除に失敗しました。',
    'data_migration_backup.admin.message.restore_confirm' => 'この「移行用デフォルト」バックアップのデータベース内容で復元します。現在のデータは上書きされます。よろしいですか？',
    'data_migration_backup.admin.message.restore_done' => 'バックアップからデータベースを復元しました。',
    'data_migration_backup.admin.message.restore_failed' => 'バックアップからの復元に失敗しました。',
    'data_migration_backup.admin.message.restore_unavailable' => 'このファイルは復元できません。移行用デフォルトのバックアップを選択してください。',
    'data_migration_backup.admin.message.delete_all_confirm' => 'すべてのバックアップを削除します。よろしいですか？',
    'data_migration_backup.admin.message.delete_all_done' => 'すべてのバックアップを削除しました。',
    'data_migration_backup.admin.message.delete_all_failed' => 'バックアップの一括削除に失敗しました。',
    'data_migration_backup.admin.message.migrate_guide_popup' => '移行用デフォルトのバックアップが作成されました。
次の手順で移行プラグインに取り込んでください。
1) データ移行アシスタント > クイックセットアップ を開く
2) ステップ1で移行元バージョンを選択し「バックアップファイルあり」を選択
3) 今ダウンロードした .tar.gz をアップロード
4) ステップ2/ステップ3で実行モードを選び移行を開始',
    'data_migration_backup.admin.modal.title' => 'バックアップ完了',
    'data_migration_backup.admin.modal.body_custom' => 'バックアップの作成が完了しました。以下のボタンからファイルをダウンロードしてください。',
    'data_migration_backup.admin.modal.body_default' => '移行用デフォルトのバックアップが作成されました。次の手順で移行プラグインに取り込んでください。',
    'data_migration_backup.admin.modal.body_assets' => 'バックアップが完了しました。移行時は以下の3ファイルをすべてダウンロードしてください。',
    'data_migration_backup.admin.modal.step1' => 'データ移行アシスタント > クイックセットアップ を開く',
    'data_migration_backup.admin.modal.step2' => 'ステップ1で移行元バージョンを選択し「バックアップファイルあり」を選択',
    'data_migration_backup.admin.modal.step3' => '今ダウンロードした .tar.gz をアップロード',
    'data_migration_backup.admin.modal.step4' => 'ステップ2 / ステップ3で実行モードを選び移行を開始',
    'data_migration_backup.admin.modal.step5' => '移行前に「移行バックアップ > 事前診断」で移行先バックアップファイルをアップロードすると、移行可否（OK/要確認/不可）とエラー内容を確認できます。',
    'data_migration_backup.admin.modal.assets_note' => '関連ファイルは移行先の既存ディレクトリへ上書き配置してください。',
    'data_migration_backup.admin.modal.confirm_three' => '上記3ファイルをすべてダウンロードしました',
    'data_migration_backup.admin.modal.confirm_generic' => '上記ファイルをすべてダウンロードしました',
    'data_migration_backup.admin.modal.to_scanner' => 'このバックアップで事前診断',
    'data_migration_backup.admin.modal.close' => '閉じる',
    'data_migration_backup.admin.modal.download' => 'ダウンロード',
