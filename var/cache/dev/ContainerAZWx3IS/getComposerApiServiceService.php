...
class getComposerApiServiceService extends Eccube_KernelDevDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['Eccube\\Service\\Composer\\ComposerApiService'] = $container->createProxy('ComposerApiServiceGhost8881cc2', static fn () => \ComposerApiServiceGhost8881cc2::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
