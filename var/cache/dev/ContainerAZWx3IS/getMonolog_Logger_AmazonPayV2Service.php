 ...
 */
class getMonolog_Logger_AmazonPayV2Service extends Eccube_KernelDevDebugContainer
{
    /**
     * Gets the public 'monolog.logger.amazon_pay_v2' shared service.
     *
     * @return \Monolog\Logger
     */
    public static function do($container, $lazyLoad = true)
    {
        $container->services['monolog.logger.amazon_pay_v2'] = $instance = new \Monolog\Logger('amazon_pay_v2');
        ...
        $instance->pushHandler(($container->privates['monolog.handler.amazon_pay'] ?? $container->load('getMonolog_Handler_AmazonPayService')));
