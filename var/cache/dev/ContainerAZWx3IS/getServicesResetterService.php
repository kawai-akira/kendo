    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () use ($container) {
            ...
            if (isset($container->privates['debug.security.firewall.authenticator.customer'])) {
                yield 'debug.security.firewall.authenticator.customer' => ($container->privates['debug.security.firewall.authenticator.customer'] ?? null);
            }
            ...
            if (isset($container->privates['monolog.handler.amazon_pay'])) {
                yield 'monolog.handler.amazon_pay' => ($container->privates['monolog.handler.amazon_pay'] ?? null);
            }
            if (isset($container->privates['monolog.handler.gmo_epsilon'])) {
                yield 'monolog.handler.gmo_epsilon' => ($container->privates['monolog.handler.gmo_epsilon'] ?? null);
            }
            if (isset($container->privates['twig.form.engine'])) {
                yield 'twig.form.engine' => ($container->privates['twig.form.engine'] ?? null);
            }
        }, fn () => 0 + (int) (isset($container->privates['Eccube\\DataCollector\\EccubeDataCollector'])) + (int) (isset($container->privates['eccube.collector.core'])) + (int) (isset($container->privates['Monolog\\Processor\\UidProcessor'])) + (int) (isset($container->services['cache.app'])) + (int) (isset($container->services['cache.system'])) + (int) (isset($container->privates['cache.validator'])) + (int) (isset($container->privates['cache.serializer'])) + (int) (isset($container->privates['cache.annotations'])) + (int) (isset($container->privates['cache.property_info'])) + (int) (isset($container->privates['mailer.message_logger_listener'])) + (int) (isset($container->privates['translation.locale_switcher'])) + (int) (isset($container->services['debug.stopwatch'])) + (int) (isset($container->services['event_dispatcher'])) + (int) (isset($container->privates['debug.log_processor'])) + (int) (isset($container->services['cache.rate_limiter'])) + (int) (isset($container->privates['rate_limiter.cache'])) + (int) (isset($container->privates['session_listener'])) + (int) (isset($container->privates['form.choice_list_factory.cached'])) + (int) (isset($container->services['cache.validator_expression_language'])) + (int) (isset($container->services['.container.private.profiler'])) + (int) (isset($container->privates['debug.validator'])) + (int) (isset($container->privates['security.token_storage'])) + (int) (isset($container->privates['cache.security_expression_language'])) + (int) (isset($container->services['cache.security_is_granted_attribute_expression_language'])) + (int) (isset($container->privates['debug.security.firewall'])) + (int) (isset($container->privates['debug.security.firewall.authenticator.api'])) + (int) (isset($container->privates['debug.security.firewall.authenticator.admin'])) + (int) (isset($container->privates['cache.security_token_verifier'])) + (int) (isset($container->privates['debug.security.firewall.authenticator.customer'])) + (int) (isset($container->services['doctrine'])) + (int) (isset($container->privates['doctrine.debug_data_holder'])) + (int) (isset($container->privates['form.type.entity'])) + (int) (isset($container->privates['monolog.handler.main'])) + (int) (isset($container->privates['monolog.handler.console'])) + (int) (isset($container->privates['monolog.handler.amazon_pay'])) + (int) (isset($container->privates['monolog.handler.gmo_epsilon'])) + (int) (isset($container->privates['twig.form.engine']))), ['Eccube\\DataCollector\\EccubeDataCollector' => ['reset'], 'eccube.collector.core' => ['reset'], 'Monolog\\Processor\\UidProcessor' => ['reset'], 'cache.app' => ['reset'], 'cache.system' => ['reset'], 'cache.validator' => ['reset'], 'cache.serializer' => ['reset'], 'cache.annotations' => ['reset'], 'cache.property_info' => ['reset'], 'mailer.message_logger_listener' => ['reset'], 'translation.locale_switcher' => ['reset'], 'debug.stopwatch' => ['reset'], 'debug.event_dispatcher' => ['reset'], 'debug.log_processor' => ['reset'], 'cache.rate_limiter' => ['reset'], 'rate_limiter.cache' => ['reset'], 'session_listener' => ['reset'], 'form.choice_list_factory.cached' => ['reset'], 'cache.validator_expression_language' => ['reset'], 'profiler' => ['reset'], 'debug.validator' => ['reset'], 'security.token_storage' => ['disableUsageTracking', 'setToken'], 'cache.security_expression_language' => ['reset'], 'cache.security_is_granted_attribute_expression_language' => ['reset'], 'debug.security.firewall' => ['reset'], 'debug.security.firewall.authenticator.api' => ['reset'], 'debug.security.firewall.authenticator.admin' => ['reset'], 'cache.security_token_verifier' => ['reset'], 'debug.security.firewall.authenticator.customer' => ['reset'], 'doctrine' => ['reset'], 'doctrine.debug_data_holder' => ['reset'], 'form.type.entity' => ['reset'], 'monolog.handler.main' => ['reset'], 'monolog.handler.console' => ['reset'], 'monolog.handler.amazon_pay' => ['reset'], 'monolog.handler.gmo_epsilon' => ['reset'], 'twig.form.engine' => ['reset']]);
    }
}
