...
class getTaxRuleServiceService extends Eccube_KernelDevDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['Eccube\\Service\\TaxRuleService'] = $container->createProxy('TaxRuleServiceGhost469872c', static fn () => \TaxRuleServiceGhost469872c::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
